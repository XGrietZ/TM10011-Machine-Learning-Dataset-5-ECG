...
# Define the hyperparameter grid for GridSearchCV and compare the feature selection SelectKBest and L1-based
param_grid = [
    {
...
plt.title('Precision-Recall Curve (Final Test Set) - SVM')
