...
ax.set_title("Learning Curve - k-Nearest Neighbor")
...
plt.ylabel('Actual')
plt.title('Confusion Matrix (Final Test Set) - k-Nearest Neighbor')
plt.show()
...
plt.title('ROC Curve (Final Test Set) - k-Nearest Neighbor')
...
plt.title('Precision-Recall Curve (Final Test Set) - k-Nearest Neighbor')
